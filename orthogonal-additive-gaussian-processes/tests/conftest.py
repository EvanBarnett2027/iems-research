...
# # Turn off TF‑2 behavior entirely
# tf.compat.v1.disable_v2_behavior()

# # Alias tf.Session back for any code/tests that call it
...
# def _ip_len(self):
#     # self.Z is an (M, D) Tensor/Variable; .shape[0] is a Python int in TF2 eager
#     return int(self.Z.shape[0])

# InducingPoints.__len__ = _ip_len
